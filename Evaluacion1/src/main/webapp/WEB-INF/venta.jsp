...
<div class="container col-md-4">
		<h4 style="text-align: center; margin-top: 20px">Ingresa una venta</h4>
		<br>
		<form class="px-2" action="/submit-venta" method="POST">
			...
			<div class="form-group">
				<label>Cantidad</label> <input type="number" placeholder="Ingresa la cantidad numérica"
					class="form-control" name="cantidad" value="${lastName}" required>
	...
	<h4 style="text-align: center; margin-bottom: 40px; margin-top: 40px">Listado de ventas</h4>
	 <div class="container">
...
<c:forEach var="temp" items="${ventas}">
 ...
 <td>
  ...
  <td>
   ...
   <td>
        <c:out value="${temp.cantidad}"></c:out>
   </td>
  
  <td>
  
    		<Form action="/eliminar-venta?id=${temp.id}"  method="POST">
