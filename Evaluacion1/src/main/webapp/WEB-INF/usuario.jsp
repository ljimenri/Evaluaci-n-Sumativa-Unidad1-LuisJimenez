...
<header>
  <nav class="navbar navbar-expand-sm navbar-dark bg-success">
	...
	<div class="container col-md-4">
		<h4 style="text-align: center; margin-top: 20px">Ingresa un usuario</h4>
		<br>
		<form class="px-2" action="/submit-usuario"" method="POST">

			<div class="form-group">
				<label>Nombre completo</label> <input type="text" placeholder="Ingresa tu nombre"
					class="form-control" name="nombreCompleto" value="${name}" required>
				<div style="color: red">${alertaNombre}</div>
				<br>
			</div>

			<div class="form-group">
				<label>Rut</label> <input type="number" placeholder="Ingresa tu rut sólo números"
					class="form-control" name="rut" value="${lastName}" required>
			...
			<div class="form-group">
				...
				<label>Contraseña</label> <input type="password" class="form-control"
					name="contrasenia" value="${limit}" placeholder="Ingresa tu contraseña" required>
	...
	<h4 style="text-align: center; margin-bottom: 40px; margin-top: 40px">Listado de usuarios</h4>
	 <div class="container">
...
<c:forEach var="temp" items="${usuarios}">
 ...
 <td>
  ...
  <td>
        <c:out value="${temp.nombreCompleto}"></c:out>
   </td>
   
   
   <td>
        <c:out value="${temp.rut}"></c:out>
   </td>
  
  <td>
  
    		<Form action="/eliminar-usuario?id=${temp.id}"  method="POST">
